...
import SearchHeader from "../widgets/landimg/searchHeader/SearchHeader";
import { charity, gifts, holidays, profileInfo } from "../shared/lib/types/userProfile";
import GiftSection from "../pages/profile.page/GiftSection";
import HolidaySection from "../pages/profile.page/HolidaySection";
import CharitySection from "../pages/profile.page/CharitySection";
